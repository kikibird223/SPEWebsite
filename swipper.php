    ...
    fetch('industrial.json')
        ...
        .then(data => {
            ...
            data.slides.forEach(slide => {
                ...
                // Add the class for the shadow effect
                imgElement.classList.add('img-shadow');

                // Optionally, you can add event listeners if you want to manage styles directly in JavaScript
                imgElement.addEventListener('mouseenter', () => {
                    imgElement.style.boxShadow = '5px 5px 15px rgba(0, 0, 0, 0.2)';
                });
